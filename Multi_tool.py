...
class ViewedImageSelector: #Détermine image, série, Z sélectionnés.
    ...
    """
    def __init__(self, selectedPath, metamorphBoolean, valeurChoixOperation, separator):
    ...
    def createChannelTunersArray(self, selectedImagePlus, defaultSelectedZDepth, defaultSelectedZProjectMethodName):
        ...
        for channelNumber in range(0,len(selectedImageAndSerieArrayOfChannels)):
            ...
            channelTuner = ChannelTuner(channelImage, channelNumber, defaultSelectedZDepth, defaultSelectedZProjectMethodName, self.selectedOperation)
...
class ChannelTuner: #Gère les réglages de chaque canal.
    ...
    def __init__(self, channelImagePlus, channelNumber, selectedZDepth, selectedZProjectMethodName, selectedOperation):
...
def openDialogBoxImageTuning(selectedPath, metamorphBoolean, selectedOperation, separator):
    imageSelector = ViewedImageSelector(selectedPath, metamorphBoolean, selectedOperation, separator)
